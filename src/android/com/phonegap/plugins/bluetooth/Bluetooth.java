...
public class Bluetooth extends CordovaPlugin
{
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext)
    {
        ...
        if (ACTION_DISCOVER_DEVICES.equals(action))
        {
            ...
            {
                Log.d(LOG_TAG + " - " + ACTION_DISCOVER_DEVICES, "Got Exception " + Ex.getMessage());
        ...
        else if (ACTION_IS_BT_ENABLED.equals(action))
        {
            try
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_IS_BT_ENABLED, "Returning " + "is Bluetooth Enabled? " + isEnabled);
                result = new PluginResult(PluginResult.Status.OK, isEnabled);
            }
            catch (Exception Ex)
            {
                Log.d(LOG_TAG + " - " + ACTION_IS_BT_ENABLED, "Got Exception " + Ex.getMessage());
                result = new PluginResult(PluginResult.Status.ERROR);
            }
        ...
        else if (ACTION_ENABLE_BT.equals(action))
        {
            try
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_ENABLE_BT, "Returning " + "Result: " + enabled);
                result = new PluginResult(PluginResult.Status.OK, enabled);
            }
            catch (Exception Ex)
            {
                Log.d(LOG_TAG + " - " + ACTION_ENABLE_BT, "Got Exception " + Ex.getMessage());
                result = new PluginResult(PluginResult.Status.ERROR);
            }
        ...
        else if (ACTION_DISABLE_BT.equals(action))
        {
            try
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_DISABLE_BT, "Returning " + "Result: " + disabled);
                result = new PluginResult(PluginResult.Status.OK, disabled);
            }
            catch (Exception Ex)
            {
                Log.d(LOG_TAG + " - " + ACTION_DISABLE_BT, "Got Exception " + Ex.getMessage());
                result = new PluginResult(PluginResult.Status.ERROR);
            }
        ...
        else if (ACTION_PAIR_BT.equals(action))
        {
            try
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_PAIR_BT, "Returning " + "Result: " + paired);
                result = new PluginResult(PluginResult.Status.OK, paired);
            }
            catch (Exception Ex)
            {
                Log.d(LOG_TAG + " - " + ACTION_PAIR_BT, "Got Exception " + Ex.getMessage());
                result = new PluginResult(PluginResult.Status.ERROR);
            }
        ...
        else if (ACTION_UNPAIR_BT.equals(action))
        {
            try
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_UNPAIR_BT, "Returning " + "Result: " + unpaired);
                result = new PluginResult(PluginResult.Status.OK, unpaired);
            }
            catch (Exception Ex)
            {
                Log.d(LOG_TAG + " - " + ACTION_UNPAIR_BT, "Got Exception " + Ex.getMessage());
                result = new PluginResult(PluginResult.Status.ERROR);
            }
        ...
        else if (ACTION_LIST_BOUND_DEVICES.equals(action))
        {
            try
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_LIST_BOUND_DEVICES, "Returning " + resultBoundDevices);
                result = new PluginResult(PluginResult.Status.OK, resultBoundDevices);

            }
            catch (Exception Ex)
            {
                Log.d(LOG_TAG + " - " + ACTION_LIST_BOUND_DEVICES, "Got Exception " + Ex.getMessage());
                result = new PluginResult(PluginResult.Status.ERROR);
            }
        ...
        else if (ACTION_STOP_DISCOVERING_BT.equals(action))
        {
            try
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_STOP_DISCOVERING_BT, "Returning " + "Result: " + stopped);
                result = new PluginResult(PluginResult.Status.OK, stopped);
            }
            catch (Exception Ex)
            {
                Log.d(LOG_TAG + " - " + ACTION_STOP_DISCOVERING_BT, "Got Exception " + Ex.getMessage());
                result = new PluginResult(PluginResult.Status.ERROR);
            }
        ...
        else if (ACTION_IS_BOUND_BT.equals(action))
        {
            try
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_IS_BOUND_BT, "Returning " + "Result: " + state);
                result = new PluginResult(PluginResult.Status.OK, state);

            }
            catch (Exception Ex)
            {
                Log.d(LOG_TAG + " - " + ACTION_IS_BOUND_BT, "Got Exception " + Ex.getMessage());
                result = new PluginResult(PluginResult.Status.ERROR);
            }
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver()
    {
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action))
            {
                ...
                {
                    Log.i(LOG_TAG, "Device already paired");
                }
            ...
            else if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action))
            {
                ...
                Log.d(LOG_TAG + " - " + ACTION_DISCOVER_DEVICES, "Returning: " + devicesFound);
